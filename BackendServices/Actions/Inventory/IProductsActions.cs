...
namespace BackendServices.Actions.Inventory
{
    ...
    {
        Task<Response> AddProduct(string createdBy, string updatedBy, Product model, string role, string companyId = null);
        Task<Response> GetProducts(string role, string companyId = null);
